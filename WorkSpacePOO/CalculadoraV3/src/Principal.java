...
public class Principal {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch(operacao) {			
			case 1:
				resultado = oper.calculoSoma(num1,num2);
				break;
			case 2:
				resultado = oper.calculoSubtracao(num1,num2);
				break;
			case 3:
				resultado = oper.calculoMultiplicacao(num1,num2);
				break;
			case 4:
				while(num2==0) {
					num2 = EntradaSaida.solicitaNumero("2º");
				}
				resultado = oper.calculoDivisao(num1,num2);
				break;
			default:
