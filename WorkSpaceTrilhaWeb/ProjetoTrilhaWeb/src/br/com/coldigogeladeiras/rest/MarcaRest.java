...
public class MarcaRest extends UtilRest{
        ...
        @Consumes("application/*")
        @Produces(MediaType.APPLICATION_JSON)
        public Response buscarNomeMarca(@QueryParam("valorBusca") String nome ) {
        	...
        	try {
        		...
        		Connection conexao = conec.abrirConexao();
        		JDBCMarcaDAO jdbcMarca = new JDBCMarcaDAO(conexao);
        		listaDeMarcas = jdbcMarca.buscarNomeMarca(nome);
        		conec.fecharConexao();
        		
        		String json = new Gson().toJson(listaDeMarcas);
        ...
        @Path("/excluir/{id}")
        @Consumes("application/*")
        public Response excluirMarca(@PathParam("id") int id) {
