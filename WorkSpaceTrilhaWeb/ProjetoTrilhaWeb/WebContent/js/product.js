...
$(document).ready(function() {
	...
	// Carrega as marcas registradas no BD no select do
	// formulário de inserir ou editar
			...
			for (var i=0; i<listaDeProdutos.length; i++){	
				tabela += "<tr>" + 
					...
					"<td>"+
						...
						"<a onclick=\"COLDIGO.produto.exibirConfirmacaoExcluir('"+listaDeProdutos[i].id+"')\"><img src='../../imgs/delete.png' " +
	...
	COLDIGO.produto.exibirConfirmacaoExcluir = function(id){
